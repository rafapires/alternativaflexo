...
<div id="wrapper"> 
  <?php include("_header.php"); ?>
    ...
    <!-- parallax  -->
    <div id="parallax2" class="parallax2 text-light text-center marginbot50" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row appear">
          <div class="col-sm-6 col-sm-offset-3">
              <div class="box">
                <div class="aligncenter">
                  <div height="368" width="100%" class="wufoo-form">
                    <h3>Seus dados foram enviados com sucesso!!!</h3>
                    <h3 style="color:orange">Dentro de alguns instantes ligaremos para você.</h3>
                    <p><i>Se você enviou esse formulário fora do horário comercial, retornaremos o telefonema pela manhã do dia útil seguinte</i></p>
                  </div>
